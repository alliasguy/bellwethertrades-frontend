  ...
  return (
    <main className='signup-page'>
      ...
      <div className="login-wrapper">
          ...
          <img src="/bellwetherlogo (1).png" alt="" className="login-logo" onClick={() => {
            navigate('/')
          }} />
          <div class="title_container">
            <p class="titles">Login to your Account</p>
            <span class="subtitle">Welcome to Bellwethertrades, login and enjoy the best investment experience.</span>
          </div>
          <br/>
